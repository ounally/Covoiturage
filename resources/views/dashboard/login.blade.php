    ...
    <div class="login_page_wrapper">
        <div class="md-card" id="login_card">
            ...
            <div class="md-card-content large-padding" id="login_password_reset" style="display: none">
                ...
                <form>
                    <div class="uk-form-row">
                        <label for="login_E-mail_reset">Your E-mail address</label>
                        <input class="md-input" type="text" id="login_E-mail_reset" name="login_E-mail_reset" />
                    </div>
                    <div class="uk-margin-medium-top">
            ...
            <div class="md-card-content large-padding" id="register_form" style="display: none">
                <button type="button" class="uk-position-top-right uk-close uk-margin-right uk-margin-top back_to_login"></button>
                <h2 class="heading_a uk-margin-medium-bottom">S'enregistrer</h2>
                <form>
                    <div class="uk-form-row">
                        <label for="register_username">E-mail</label>
                        <input class="md-input" type="email" id="register_username" name="register_username" />
                    </div>
                    <div class="uk-form-row">
                    ...
                    <div class="uk-form-row">
                        <label for="register_E-mail">E-mail</label>
                        <input class="md-input" type="text" id="register_E-mail" name="register_E-mail" />
                    </div>
                    <div class="uk-margin-medium-top">
        ...
        <div class="uk-margin-top uk-text-center">
            <a href="#" id="signup_form_show">S'enregistrer</a>
        </div>
    </div>
